 ...
 * 一个基于NavigableMap 实现的红黑树。这个map根据key自然排序存储，或者通过Comparator
 * 在创建时提供，取决于使用的构造函数。
 *
 ...
 * 注意 TreeMap 维护的排序，像任何SortedMap一样，并且是否提供显示比较器，必须与equals保持一致
 *
 *
