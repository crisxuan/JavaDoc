 ...
 * {@code char}.
 * Character 类是 Char 基本数据类型的私有包装器。
 *
 * <p>
 ...
 * <p>
 * 此外，该类提供了几种方法来确定字符的类别（小写字母，数字等）以及将字符从大写转换为小写，
 * 反之亦然。
 *
...
class Character implements java.io.Serializable, Comparable<Character> {
     ...
     * 可用于转换为字符串和从字符串转换的最小进制数，也就是二进制。
     * 此进制数值是基数转换方法中 radix 参数允许的最小值，例如 digit 方法，
     * forDigit 方法，和Integer 类的 toString 方法。
     *
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
     ...
     * 如果进制数不在 MIN_RADIX <= radix <= MAX_RADIX 的范围内或者ch的值
     * 在特定进制内不是一个有效的数字，那么就返回 -1。必须满足一下至少一个条件
     * 的字符才是一个有效数字。
     *
     * <ul>
     ...
     *     这个 isDigit 方法是正确的字符并且 Unicode 的十进制数的值小于指定的进制时
     *     在这种情况下将返回十进制数的值。
     *
     ...
     *     is returned.
     *     这个字符是大写的拉丁字符 'A' 到 'Z' 之一，其代码要小于 radix + 'A' - 10
     *     在这个情况下， ch - 'A' + 10 会返回。
     *
     ...
     *     In this case, {@code ch - 'a' + 10}
     *     is returned.
     *     这个字符是小写的拉丁字符 'a' 到 'z' 其中之一，其代码要小于 radix + 'a' - 10，
     *     这种情况下， ch - 'a' + 10 会返回。
     *
     ...
     *     is returned.
     *     该字符是全宽大写拉丁字母 'A' 到 'Z' 之一，其代码小于 radix + '\u005CuFF21' - 10
     *     这种情况下，返回 ch - '\u005CuFF21' + 10
     *
     ...
     *     is returned.
     * </ul>
     *     该字符是全宽小写拉丁字母 'a' 到 'a' 之一，其代码小于 radix + '\u005CuFF41' - 10
     *     这种情况下，返回 ch - '\u005CuFF41' + 10
     *
     * <p><b>Note:</b> This method cannot handle <a
     * href="#supplementary"> supplementary characters</a>. To support
     * all Unicode characters, including supplementary characters, use
